...
print(f'num negativi: {len(X_neg)}')
...
#
# print(f'length of data used to evaluate FPR: {len(X_evaluate[y_evaluate==0])}')


print('building filter with pretrained mlp')
filter_pretrained = lbf.LBF(epsilon=0.01, classifier=mlp, fpr_test_size=0,
...
# mlp = ScoredMLP()
# filter_untrained = lbf.LBF(epsilon=0.01, classifier=mlp, fpr_test_size=0,
#                  threshold_test_size=0.2,
...
# filter_reused = lbf.LBF(epsilon=0.01, classifier=reused_mlp, fpr_test_size=0,
#                  threshold_test_size=0.2,
#                  num_candidate_thresholds=5000)
...
# mlp = ScoredMLP()
# filter = lbf.LBF(epsilon=0.01, classifier=mlp, fpr_test_size=0,
#                  threshold_test_size=0.2,
#                  num_candidate_thresholds=5000,
