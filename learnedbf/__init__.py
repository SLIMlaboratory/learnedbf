...
class FastPLBF(BaseEstimator, BloomFilter, ClassifierMixin):
    ...
    def __init__(self,
                 ...
                 N=1000,
                 verbose=False):
        """Create an instance of :class:`FastPLBF`.
    ...
    def fit(self, X, y):
        ...
        if self.m is not None:
            ...
            for num_group in range(self.num_group_min, self.num_group_max+1):
                f = SupportFastPLBF(#X_pos.tolist(),
                                [bytes(i) for i in X_pos],
                                key_scores.tolist(),
                                nonkey_scores.tolist(),
                                self.epsilon,
...
class FastPLBFpp(BaseEstimator, BloomFilter, ClassifierMixin):
    ...
    def __init__(self,
                 ...
                 N=1000,
                 verbose=False):
        """Create an instance of :class:`FastPLBFpp`.
    ...
    def fit(self, X, y):
        ...
        if self.m is not None:
            ...
            for num_group in range(self.num_group_min, self.num_group_max+1):
                f = SupportFastPLBFpp(#X_pos.tolist(),
                                [bytes(i) for i in X_pos],
                                key_scores.tolist(),
                                nonkey_scores.tolist(),
                                self.epsilon,
